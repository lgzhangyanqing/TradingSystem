...
public class MailRegister {
	...
	/*
	 * when a new user click the button of the register, there are two things happend 
	 * 1. store you information to the database
	 * 2. send the activity email
	 */
	
	
	/*
	 * 1. store the user information to the database 
	 */
	...
	/*
	 * update the user database status after the user click the activate link
	 */
